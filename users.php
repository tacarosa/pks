						...
						<table id="user" class="table table-striped table-bordered table-hover">
							<thead>
								<tr style="font-size: 13px;">
									...
									<th style="vertical-align: middle;"><center>Tipe User</center></th>
									<th style="vertical-align: middle;"><center>Kode Cabang</center></th>
									<th style="vertical-align: middle;"><center>Status User</center></th>								
							...
							<tbody>
								<tr>
									...
									<td style="vertical-align: middle;"><?php echo $data['cabang']; ?></td>
									<td style="vertical-align: middle;"><?php echo $data['status']; ?></td>						
									<td>
										<center>
											<a href="index.php?page=edit_users&id=<?php echo $data['id'] ?>" onclick="return confirm('Apakah Anda Yakin Mengedit Data ?')" class="btn btn-warning" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
											<a href="index.php?page=hapus_users&id=<?php echo $data['id'] ?>" onclick="return confirm('Apakah Anda Yakin Menghapus Data ?')" class="btn btn-danger" title="Hapus"><i class="fa fa-trash-o"></i></a>
											<a href="index.php?page=edit_pass&id=<?php echo $data['id'] ?>" onclick="return confirm('Apakah Anda Yakin Mereset Password?')" class="btn btn-success" title="Reset"><i class="fa fa-history"></i></a>
										</center>
									</td>
								</tr>
								<?php 
