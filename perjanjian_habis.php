	...
	<div class="">
 		...
 		<div class="row">
 			<div class="col-md-12 col-sm-12 col-xs-12">
 				<div class="x_panel">
 					<div class="x_title"> 						
						 &nbsp; &nbsp;<a href="export_xls_perjanjian_habis.php" class="btn btn-info btn-sm"><i class="fa fa-download"></i> Download</a>		
 						...
 						<table id="pekerjaan" width="150%" class="table table-striped table-bordered table-hover">
 							...
 							<tbody>
 								<tr>
 									<?php
 										$no=1;
 										$query	= "SELECT * FROM perjanjian WHERE status <> 'Arsip' AND DATE(selesai) <= DATE(NOW()) ORDER BY tanggal ASC";
