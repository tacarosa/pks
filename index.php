				...
				<div class="col-md-3 left_col">
					<div class="left_col scroll-view" style="background-color: #318ce7">
						...
						<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
							...
							<?php
							if($_SESSION['level'] == 'superadmin' || $_SESSION['level'] == 'admin' || $_SESSION['level'] == 'admin1' || $_SESSION['level'] == 'user' || $_SESSION['level'] == 'user1'){
							?>
							...
							<!-- User AdminUser -->
							<?php
							 } else if($_SESSION['level'] == 'adminuser'){
							 ?>							
							...
							<!-- User AdminData -->
							<?php
							 } else if($_SESSION['level'] == 'admindata'){
							 ?>						
  ...
  $(function () {
    ...
    <?php
    	//
          ...
          $count1a = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM perjanjian WHERE MONTH(tanggal)='1'"));
          $count2a = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM perjanjian WHERE MONTH(tanggal)='2'"));
          $count3a = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM perjanjian WHERE MONTH(tanggal)='3'"));
          $count4a = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM perjanjian WHERE MONTH(tanggal)='4'"));
          $count5a = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM perjanjian WHERE MONTH(tanggal)='5'"));
          $count6a = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM perjanjian WHERE MONTH(tanggal)='6'"));
          $count7a = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM perjanjian WHERE MONTH(tanggal)='7'"));
          $count8a = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM perjanjian WHERE MONTH(tanggal)='8'"));
          $count9a = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM perjanjian WHERE MONTH(tanggal)='9'"));
          $count10a = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM perjanjian WHERE MONTH(tanggal)='10'"));
          $count11a = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM perjanjian WHERE MONTH(tanggal)='11'"));
          $count12a = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM perjanjian WHERE MONTH(tanggal)='12'"));

          $count1b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM mou WHERE MONTH(tanggal)='1'"));
          $count2b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM mou WHERE MONTH(tanggal)='2'"));
          $count3b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM mou WHERE MONTH(tanggal)='3'"));
          $count4b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM mou WHERE MONTH(tanggal)='4'"));
          $count5b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM mou WHERE MONTH(tanggal)='5'"));
          $count6b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM mou WHERE MONTH(tanggal)='6'"));
          $count7b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM mou WHERE MONTH(tanggal)='7'"));
          $count8b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM mou WHERE MONTH(tanggal)='8'"));
          $count9b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM mou WHERE MONTH(tanggal)='9'"));
          $count10b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM mou WHERE MONTH(tanggal)='10'"));
          $count11b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM mou WHERE MONTH(tanggal)='11'"));
          $count12b = mysqli_num_rows(mysqli_query($connect, "SELECT tanggal AS total FROM mou WHERE MONTH(tanggal)='12'"));         
    ?>
    //BAR CHART
