	...
	<div class="">
 		...
 		<div class="row">
 			<div class="col-md-12 col-sm-12 col-xs-12">
 				<div class="x_panel">
 					<div class="x_title"> 						
						 &nbsp; &nbsp;<a href="export_xls_perjanjian_kurang3bln.php" class="btn btn-info btn-sm"><i class="fa fa-download"></i> Download</a>		
 						...
 						<table id="pekerjaan" width="150%" class="table table-striped table-bordered table-hover">
 							...
 							<tbody>
 								<tr>
 									<?php
 										$no=1;
 										$query	= "SELECT * FROM perjanjian WHERE status <> 'Arsip' AND selesai BETWEEN DATE(NOW()) AND DATE(NOW()) + INTERVAL 3 MONTH ORDER BY tanggal ASC";
									...
									<td style="vertical-align: middle;"><?php echo $data['status']; ?></td> 
 									...
 									<td>
 										<center style="display : flex">
 											<a href="index.php?page=edit_perjanjian&id=<?php echo $data['id_perjanjian']; ?>" onclick="return confirm('Apakah Anda Ingin Mengedit Data ?')" class="btn btn-warning" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
