...
<html>
<head>
  <title>Daftar Perjanjian Kerjasama Addendum</title>
...
<div class="container">		
        	...
        	<center><h5>Daftar Perjanjian Kerjasama Addendum</h5></center>
 							...
 							<tbody>
 								<tr>
 									<?php											
										$idDok = $_GET['id'];									
 										$no=1;
 										$query	= "SELECT * FROM perjanjian WHERE id_addendum = '$idDok'  ORDER BY tanggal ASC";
