...
<html>
<head>
  <title>Daftar Semua Perjanjian Kerjasama Aktif</title>
...
<div class="container">		
        	...
        	<center><h5>Daftar Semua Perjanjian Kerjasama Aktif</h5></center>
 						...
 						<thead>
 							...
 							<tbody>
 								<tr>
 									<?php
 										$no=1;
 										$query	= "SELECT * FROM perjanjian WHERE status <> 'Arsip' AND cabang = $cabang ORDER BY tanggal ASC"; 												
