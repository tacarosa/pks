	<?php
		if (isset($_REQUEST['edit'])) {		
			...
			//jika filenya ada, hapus filenya
				if (file_exists("upload/pks/".$data['file'])){
					unlink("upload/pks/".$data['file']);
				}

		
			
			//jika mengubah file		
				$query 	= "UPDATE perjanjian SET nomor='$nomor', tanggal='$tanggal', phk_1='$phk_1', phk_2='$phk_2', phk_3='$phk_3', judul='$judul', mulai='$mulai', selesai='$selesai', status='$status', user='$user', tipe='$tipe', cabang='$cabang', file='$file' WHERE id_perjanjian='$_GET[id]'";			
				$sql   	= mysqli_query($connect, $query);
			...
			//jika tidak mengubah file
				$query 	= "UPDATE perjanjian SET nomor='$nomor', tanggal='$tanggal', phk_1='$phk_1', phk_2='$phk_2', phk_3='$phk_3', judul='$judul', mulai='$mulai', selesai='$selesai', status='$status', user='$user', tipe='$tipe', cabang='$cabang' WHERE id_perjanjian='$_GET[id]'";
				...
				if ($sql) {
					// echo '<script language="javascript">
					// 	  window.alert("Data berhasil di ubah")
               	  	// 	  window.location.href="./index.php?page=perjanjian";						  
              	  	// 	  </script>';
					echo '<script language="javascript">
						  window.alert("Data berhasil di ubah")
						  window.history.go(-2);						  
	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3>Edit Perjanjian Kerjasama</h3>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2>Form Edit Perjanjian Kerjasama</h2>
