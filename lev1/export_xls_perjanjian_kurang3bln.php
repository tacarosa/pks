...
<html>
<head>
  <title>Daftar Perjanjian Kerjasama Kurang 3 Bulan</title>
...
<div class="container">		
        	...
        	<center><h2>Daftar Perjanjian Kerjasama Kurang 3 Bulan</h2></center>
					
				<table id="perjanjian" class="table table-striped table-bordered table-hover">
 						<thead>
 							...
 							<tbody>
 								<tr>
 									<?php
 										$no=1;
 										$query	= "SELECT * FROM perjanjian WHERE status <> 'Arsip' AND selesai BETWEEN DATE(NOW()) AND DATE(NOW()) + INTERVAL 3 MONTH AND cabang = $cabang ORDER BY tanggal ASC";
