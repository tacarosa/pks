...
<html>
<head>
  <title>Daftar Semua MoU Habis Masa Berlaku</title>
...
<div class="container">		
        	...
        	<center><h2>Daftar Semua MoU Habis Masa Berlaku</h2></center>
 						...
 						<thead>
 							...
 							<tbody>
 								<tr>
 									<?php
 										$no=1;
 										$query	= "SELECT * FROM mou WHERE status <> 'Arsip' AND DATE(selesai) <= DATE(NOW()) AND cabang = $cabang ORDER BY tanggal ASC";
