	...
	<div class="">
 		...
 		<div class="row">
 			<div class="col-md-12 col-sm-12 col-xs-12">
 				<div class="x_panel">
 					<div class="x_title"> 						
						 &nbsp; &nbsp;<a href="index.php?page=tambah_mou" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah</a>
						 &nbsp; &nbsp;<a href="export_xls_mou.php" class="btn btn-info btn-sm"><i class="fa fa-download"></i> Download</a>		
 						...
 						<table id="pekerjaan" width="150%" class="table table-striped table-bordered table-hover">
 							...
 							<tbody>
 								<tr>
 									<?php
 										$no=1;
 										$query	= "SELECT * FROM mou WHERE status <> 'Arsip'  ORDER BY tanggal ASC";
 									...
 									<td style="vertical-align: middle;">
									 	<a href="index.php?page=mou_addendum&id=<?php echo $data['id_addendum']; ?>"><b><?php echo $data['nomor'];?></b></a><br>
									</td>
									...
									<td style="vertical-align: middle;">
										<a href="index.php?page=mou_addendum&id=<?php echo $data['id_addendum']; ?>"><b><?php echo $data['judul'];?></b></a><br>
									</td>
									...
									<td style="vertical-align: middle;"><?php echo $data['status']; ?></td> 
 									...
 									<td>
 										<center style="display : flex">
										 	<a href="index.php?page=mou_addendum&id=<?php echo $data['id_addendum']; ?>" class="btn btn-success" title="Lihat"><i class="fa fa-eye"></i></a>
