<?php
		if (isset($_REQUEST['edit'])) {	
			...
			$keterangan	= $_POST['keterangan'];	
				...
				//jika mengubah file		
				$query 	= "UPDATE cabang SET kode='$kode', keterangan='$keterangan' WHERE id_cabang='$_GET[id]'";				
	...
	<div class="">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2>Form Edit Keterangan Cabang</h2>
					...
					<div class="x_content">
						<!-- Form Edit Users -->
						<?php
							$query	= "SELECT * FROM cabang WHERE id_cabang='$_GET[id]'";
							$sql 	= mysqli_query($connect, $query);
						...
						<form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="kode" class="form-control col-md-7 col-xs-12" required="required" value="<?php echo $data['kode'] ?>">
								</div>
							</div>
							<div class="item form-group">
